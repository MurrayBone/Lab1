...
```{r setup-tibble}
team_data <- tibble(
  name = c("Peter Rabbit", "Ade", "max", 
           "Connor", "Cameron"),
  github_username = c("mcgregors-garden", "ade8734", "s2487351", 
                      "Con-fin", "Ca3eron"), 
  colour = c("powderblue", "orange", "blue", 
             "lightsteelblue1", "royalblue"),
  hobby = c("Hopping", "Basketball", "Chess", 
            "Drawing", "Photography"),
  favourite_number = c(2, 5, 7, 9, 4)
  )
